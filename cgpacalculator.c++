...
struct Course
{                                                            
    string name;                                             //Taking course name
    float creditHours;                                       //Taking course credit hours
    float gradePoints;                                      //Taking grades of the entire course
    string grade;
};
...
int main()
{
    int numCourses;         // total number of courses
    ...
    for (int i = 0; i < numCourses; i++)
    {
        ...
        {
            cout << "Invaild Obtain Marks for " << course.name << endl;
